              ...
              <div className="h-96">
                <div className="flex flex-col gap-2">
                  ...
                  {recentCareers && recentCareers.map((career, index) => (
                    <Link href={`/admin/careers/${career.id}`} key={`recent-career-item-${index}`} className="p-3 flex flex-row items-center gap-2 hover:bg-gray-100 active:bg-gray-200 rounded-2xl">
                      <div>
